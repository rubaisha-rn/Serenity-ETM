const SUPABASE_ASSET_URL = 'https://funqzsdhvrnloatkmipm.supabase.co/storage/v1/object/public/ui-assets'

export const ICONS = {
    light: {
        dashboard: `${SUPABASE_ASSET_URL}/icons/lightMode/dashboard.png`,

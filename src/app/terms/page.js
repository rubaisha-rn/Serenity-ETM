 ...
 * Terms page
 * 
 * Renders legal and informational content about the application prototype.
 */
    ...
    return (
        ...
        >
            ...
            <div className="flex flex-col items-center">
                ...
                <article className="flex flex-col terms bg-white" role="document">
